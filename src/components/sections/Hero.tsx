...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container-luxe relative z-10 grid gap-8 pt-2 pb-24 sm:gap-10 sm:pt-4 sm:pb-28 md:pt-4 md:pb-14 lg:min-h-[calc(82svh-88px)] lg:grid-cols-12 lg:items-center lg:gap-8 lg:pt-6 lg:pb-28">
        <div className="order-1 lg:col-span-6 xl:col-span-5">
          ...
          >
            ...
            <div className="relative mb-3 overflow-hidden sm:mb-4">
              <span
                className="block max-w-full font-display text-[20vw] font-light leading-[0.85] tracking-[-0.04em] text-transparent sm:text-[14vw] md:text-[10vw] lg:text-[6.5vw]"
                style={{
            ...
            <h1 className="max-w-md font-display text-2xl font-light leading-snug text-white sm:text-2xl md:text-2xl xl:text-2xl">
              {BRAND.tagline}
            </h1>
        ...
        <div className="order-2 lg:col-span-6 xl:col-span-7">
          ...
          >
            <div className="mb-3 flex items-end justify-between px-1 sm:mb-4">
              ...
              <p className="text-[10px] uppercase tracking-[0.18em] text-gold sm:text-[11px] sm:tracking-[0.22em]">
              MFM MARBLE & GRANITE
              </p>
            </div>
